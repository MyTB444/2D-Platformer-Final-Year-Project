...
-06/02/2025
I have improved the menu. It looks much better and interactable. The highest score is displayed on the start button. The objective of the game is to save the pope, and the player is trying to reach the pope as fast as possible. I will now have a second game mode, an endless combat area. There will be an algorythm continously increasing the difficulty of the game and spawning random enemies. I have around 5 different enemy types so we have a good variety. As I am also having the game tested, I am regularly fixing buggs and making minor quality of life adjustments.
-07/02/2025
